...
import { Text, Box, HStack, VStack, Image, Center, useDisclosure } from '@chakra-ui/react'
...
const Video = ({video}) => {
  ...
  return (
    <>
    <HStack>
      <Image src={videoThumbnail} htmlWidth="200" htmlHeight="120" mr="3%" alt="thumb" onClick={onVideoDetailsOpen}></Image>
      <VStack w="100%">
    ...
    <Box
      ...
      mb={10}
    />
    <ModalVideoDetails isOpen={isVideoDetailsOpen} onClose={onVideoDetailsClose} metadata={metadata}/>
    </>
  )
}
