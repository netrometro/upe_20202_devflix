...
public class VideoCRUDService implements IVideoCRUDService {
  ...
  public Video protectedCreate(String authHeader, Video video, Long categoryId) {
    ...
    Video addedVideo = videoService.insert(video.setCategory(category).setOwner(owner).setMetadata(metadata));
  ...
  public Video protectedUpdate(String authHeader, Long videoId, Video video) {
  ...
  public Video protectedDelete(String authHeader, Long videoId) {
